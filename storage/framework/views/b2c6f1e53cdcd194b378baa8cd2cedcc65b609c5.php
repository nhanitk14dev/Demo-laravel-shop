        ...
        <div class="modal-content modal-col-red">
            <form action="" method="post">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-link waves-effect"><?php echo trans("button.delete"); ?></button>
                    <button type="button" class="btn btn-link waves-effect" data-dismiss="modal"><?php echo trans("button.close"); ?></button>
                </div>
            </form>
        </div>
    </div>
