			...
			<div class="span9">
				...
				<div class="row">	  
					<div id="gallery" class="span3">
						<a href="/assets/themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
							<img src="/assets/themes/images/products/large/3.jpg" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
						</a>
						<div id="differentview" class="moreOptopm carousel slide">
							<div class="carousel-inner">
								<div class="item active">
									<a href="/assets/themes/images/products/large/f1.jpg"> <img style="width:29%" src="/assets/themes/images/products/large/f1.jpg" alt=""/></a>
									<a href="/assets/themes/images/products/large/f2.jpg"> <img style="width:29%" src="/assets/themes/images/products/large/f2.jpg" alt=""/></a>
									<a href="/assets/themes/images/products/large/f3.jpg" > <img style="width:29%" src="/assets/themes/images/products/large/f3.jpg" alt=""/></a>
								</div>
								<div class="item">
									<a href="/assets/themes/images/products/large/f3.jpg" > <img style="width:29%" src="/assets/themes/images/products/large/f3.jpg" alt=""/></a>
									<a href="/assets/themes/images/products/large/f1.jpg"> <img style="width:29%" src="/assets/themes/images/products/large/f1.jpg" alt=""/></a>
  		...
  		<div class="tab-pane fade active in" id="home">
  			...
  			<div class="tab-content">
  				<div class="tab-pane" id="listView">
  					...
  					<div class="row">	  
  						<div class="span2">
  							<img src="/assets/themes/images/products/6.jpg" alt=""/>
  						</div>
  						<div class="span4">
  							<h3>New | Available</h3>				
  							<hr class="soft"/>
  					...
  					<div class="row">	  
  						<div class="span2">
  							<img src="/assets/themes/images/products/7.jpg" alt=""/>
  						</div>
  						<div class="span4">
  							<h3>New | Available</h3>				
  							<hr class="soft"/>
  					...
  					<div class="row">	  
  						<div class="span2">
  							<img src="/assets/themes/images/products/8.jpg" alt=""/>
  						</div>
  						<div class="span4">
  							<h3>New | Available</h3>				
  							<hr class="soft"/>
  					...
  					<div class="row">	  
  						<div class="span2">
  							<img src="/assets/themes/images/products/9.jpg" alt=""/>
  						</div>
  						<div class="span4">
  							<h3>New | Available</h3>				
  							<hr class="soft"/>
  				...
  				<div class="tab-pane active" id="blockView">
  					<ul class="thumbnails">
  						<li class="span3">
  							<div class="thumbnail">
  								<a href="<?php echo e(route('front.product.show')); ?>"><img src="/assets/themes/images/products/10.jpg" alt=""/></a>
  								<div class="caption">
  									<h5>Manicure &amp; Pedicure</h5>
  									<p> 
  										Lorem Ipsum is simply dummy text. 
  									</p>
  									<h4 style="text-align:center"><a class="btn" href="<?php echo e(route('front.product.show')); ?>"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">&euro;222.00</a></h4>
  								</div>
  							</div>
  						</li>
  						<li class="span3">
  							<div class="thumbnail">
  								<a href="<?php echo e(route('front.product.show')); ?>"><img src="/assets/themes/images/products/11.jpg" alt=""/></a>
  								<div class="caption">
  									<h5>Manicure &amp; Pedicure</h5>
  									<p> 
  										Lorem Ipsum is simply dummy text. 
  						...
  						<li class="span3">
  							<div class="thumbnail">
  								<a href="<?php echo e(route('front.product.show')); ?>"><img src="/assets/themes/images/products/12.jpg" alt=""/></a>
  								<div class="caption">
  									<h5>Manicure &amp; Pedicure</h5>
  									<p> 
  										Lorem Ipsum is simply dummy text. 
  						...
  						<li class="span3">
  							<div class="thumbnail">
  								<a href="<?php echo e(route('front.product.show')); ?>"><img src="/assets/themes/images/products/13.jpg" alt=""/></a>
  								<div class="caption">
  									<h5>Manicure &amp; Pedicure</h5>
  									<p> 
  										Lorem Ipsum is simply dummy text. 
  						...
  						<li class="span3">
  							<div class="thumbnail">
  								<a href="<?php echo e(route('front.product.show')); ?>"><img src="/assets/themes/images/products/1.jpg" alt=""/></a>
  								<div class="caption">
  									<h5>Manicure &amp; Pedicure</h5>
  									<p> 
  										Lorem Ipsum is simply dummy text. 
  						...
  						<li class="span3">
  							<div class="thumbnail">
  								<a href="<?php echo e(route('front.product.show')); ?>"><img src="/assets/themes/images/products/2.jpg" alt=""/></a>
  								<div class="caption">
  									<h5>Manicure &amp; Pedicure</h5>
  									<p> 
  										Lorem Ipsum is simply dummy text. 
