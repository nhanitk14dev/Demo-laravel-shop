  			...
  			<div class="tab-content">
  				...
  				<div class="tab-pane active" id="blockView">
  					<ul class="thumbnails">
  						...
  						<li class="span3">
  							<div class="thumbnail">
  								<a href="{{route('front.product.show')}}"><img src="/assets/themes/images/products/12.jpg" alt=""/></a>
  								<div class="caption">
  									<h5>Manicure &amp; Pedicure</h5>
  									<p> 
  										Lorem Ipsum is simply dummy text. 
  						...
  						<li class="span3">
  							<div class="thumbnail">
  								<a href="{{route('front.product.show')}}"><img src="/assets/themes/images/products/13.jpg" alt=""/></a>
  								<div class="caption">
  									<h5>Manicure &amp; Pedicure</h5>
  									<p> 
  										Lorem Ipsum is simply dummy text. 
  						...
  						<li class="span3">
  							<div class="thumbnail">
  								<a href="{{route('front.product.show')}}"><img src="/assets/themes/images/products/1.jpg" alt=""/></a>
  								<div class="caption">
  									<h5>Manicure &amp; Pedicure</h5>
  									<p> 
  										Lorem Ipsum is simply dummy text. 
  						...
  						<li class="span3">
  							<div class="thumbnail">
  								<a href="{{route('front.product.show')}}"><img src="/assets/themes/images/products/2.jpg" alt=""/></a>
  								<div class="caption">
  									<h5>Manicure &amp; Pedicure</h5>
  									<p> 
  										Lorem Ipsum is simply dummy text. 
