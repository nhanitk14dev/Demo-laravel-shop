...
<body>
	...
	<script src="/assets/themes/js/google-code-prettify/prettify.js" type="text/javascript"></script>
	<script src="/assets/themes/js/jquery.lightbox-0.5.js" type="text/javascript"></script>
	
	<script src="/assets/themes/js/bootshop.js" type="text/javascript"></script>
