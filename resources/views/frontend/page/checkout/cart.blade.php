      ...
      <div class="row margin-bottom-40">
        ...
        <div class="col-md-12 col-sm-12">
          ...
          <div class="goods-page">
            ...
            <a href="/"><button class="btn btn-default" type="text">Continue shopping <i class="fa fa-shopping-cart"></i></button></a>
            <a href="{{ route('page.checkout') }}"><button class="btn btn-primary" type="submit">Checkout<i class="fa fa-check"></i></button></a>
          </div>
        </div>
        <!-- END CONTENT -->
      </div>
