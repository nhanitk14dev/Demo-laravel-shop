          ...
          <div class="panel-group checkout-page accordion scrollable" id="checkout-page">
              ...
              <div class="panel-heading">
                <h2 class="panel-title">
                  <a data-toggle="collapse" data-parent="#checkout-page" href="#checkout-content" class="accordion-toggle">
                    {{ trans('f_checkout.step1') }}: {{ trans('f_checkout.step1_') }}
                  </a>
                </h2>
              </div>
              ...
              <div class="panel-heading">
                <h2 class="panel-title">
                  <a data-toggle="collapse" data-parent="#checkout-page" href="#payment-address-content" class="accordion-toggle">
                    {{ trans('f_checkout.step2') }}: {{ trans('f_checkout.step2_') }}
                  </a>
                </h2>
              </div>
            ...
            <div id="shipping-address" class="panel panel-default">
              <div class="panel-heading">
                <h2 class="panel-title">
                  ...
                  {{ trans('f_checkout.step3') }}: {{ trans('f_checkout.step3_') }}
                  </a>
                </h2>
              </div>
                  ...
                  <div class="col-md-6 col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control input-sm" id="region-state-dd">
                        <option value=""> --- Chọn --- </option><option value="3513">Aberdeen</option><option value="3514">Aberdeenshire</option><option value="3515">Anglesey</option><option value="3516">Angus</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-12">
              ...
              <div class="panel-heading">
                <h2 class="panel-title">
                  <a data-toggle="collapse" data-parent="#checkout-page" href="#shipping-method-content" class="accordion-toggle">
                    {{ trans('f_checkout.step4') }}: {{ trans('f_checkout.step4_') }}
                  </a>
                </h2>
              </div>
              <div id="shipping-method-content" class="panel-collapse collapse">
                <div class="panel-body row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label for="delivery-comments">Thêm bình luận</label>
            ...
            <div id="payment-method" class="panel panel-default">
              <div class="panel-heading">
                <h2 class="panel-title">
                  <a data-toggle="collapse" data-parent="#checkout-page" href="#payment-method-content" class="accordion-toggle">
                    {{ trans('f_checkout.step5') }}: {{ trans('f_checkout.step5_') }}
                  </a>
                </h2>
              </div>
              <div id="payment-method-content" class="panel-collapse collapse">
                <div class="panel-body row">
                  <div class="col-md-12">
                    <p>Vui lòng chọn phương thức trả tiền.</p>
                    <div class="radio-list">
                      <label>
                    ...
                    <div class="form-group">
                      <label for="delivery-payment-method">Thêm bình luận vào sản phẩm</label>
                    ...
                    <div class="checkbox pull-right">
                      <label>
                        <input type="checkbox"> Tôi đã đọc và đồng ý điều khoản <a title="Terms & Conditions" href="javascript:;">Terms & Conditions </a> &nbsp;&nbsp;&nbsp;
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <div class="panel-heading">
                <h2 class="panel-title">
                  <a data-toggle="collapse" data-parent="#checkout-page" href="#confirm-content" class="accordion-toggle">
                    {{ trans('f_checkout.step6') }}: {{ trans('f_checkout.step6_') }}
                  </a>
                </h2>
              </div>
                    ...
                    <table>
                      ...
                      <tr>
                        <td class="checkout-image">
                          <a href="javascript:;"><img src="assets/themes/pages/img/products/model3.jpg" alt="Berry Lace Dress"></a>
                        </td>
                        <td class="checkout-description">
                          <h3><a href="javascript:;">đầm xanh </a></h3>
                          <p><strong>Item 1</strong> - Color: Green; Size: S</p>
                          <em>xem thêm chi tiết tại đây</em>
                        </td>
                      ...
                      <tr>
                        <td class="checkout-image">
                          <a href="javascript:;"><img src="assets/themes/pages/img/products/model4.jpg" alt="Berry Lace Dress"></a>
                        </td>
                        <td class="checkout-description">
                          <h3><a href="javascript:;">đầm xanh </a></h3>
                          <p><strong>Item 1</strong> - Color: Green; Size: S</p>
