...
<div id="mainBody">
	<div class="container">
		<div class="row">
			...
			<!-- Sidebar start span9-right=============================================== -->
			<div class="span9">
				<ul class="breadcrumb">
					<li><a href="index.html">Home</a> <span class="divider">/</span></li>
					<li class="active"> SHOPPING CART</li>
				</ul>
				<h3>  {!! trans('f_cart.shopping_cart') !!} [ <small>3 Item(s) </small>]<a href="products.html" class="btn btn-large pull-right"><i class="icon-arrow-left"></i> Continue Shopping </a></h3>	
				<hr class="soft"/>
			...
			<!--end sidebar content span9-right-->
		</div>
	</div>
</div>
